    ...
    return function () {
        describe('View', function () {
            ...
            it('show()/hide()-sequense', function (done) {
                ...
                var GrandChildA = View.extend('test.view.GrandChildA', { vidx: 'grand_child_a' });
                var GrandChildB = View.extend('test.view.GrandChildB', { vidx: 'grand_child_b' });

                var parent_a = manager.create('/@', ParentA);
                var child_a = manager.create('/@/parent_a', ChildA);
                var child_b = manager.create('/@/parent_a', ChildB);
                var g_child_b = manager.create('/@/parent_a/child_b', GrandChildA);
